...
public class TerminalIdStep {
	...
	@When("^I validate Terminal Id (.+)$")
	public void i_validate_order_date(String terminalId) throws Throwable {
		report = testValidatorUrils.getValidReport();
		report.setTerminalId(terminalId);
	}


	@Then("^the Terminal Id validation result should be should be (.+)$")

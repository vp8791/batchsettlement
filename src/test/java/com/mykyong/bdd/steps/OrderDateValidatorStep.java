...
public class OrderDateValidatorStep {
	...
	@When("^I validate Order Date (.+)$")
	public void i_validate_order_date(String orderdate) throws Throwable {
		report = testValidatorUrils.getValidReport();
		DateFormat sourceFormat = new SimpleDateFormat("dd-MM-yyyy");
		Date date = sourceFormat.parse(orderdate);
		report.setOrderDate(date);
	}


	@Then("^the Order date validation result should be should be (.+)$")

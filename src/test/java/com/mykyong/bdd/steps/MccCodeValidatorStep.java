...
public class MccCodeValidatorStep {
	...
	@When("^I validate Mcc Code (.+)$")
	public void i_validate_order_date(String mccCode) throws Throwable {
		report = testValidatorUrils.getValidReport();
		report.setMccCode(mccCode);
	}


	@Then("^the Mcc Code validation result should be should be (.+)$")
